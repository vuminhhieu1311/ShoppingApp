...
export default class OrderDetail extends Component {
    ...
    cancelOrder() {
        const { orderId } = this.props.route.params;
        if (this.state.orderStatus == "Completed" || this.state.orderStatus == "Cancelled") {
            Alert.alert(
                'Unsuccessfully',
    ...
    render() {
        const {
            ...
            itemStyle, itemImg, itemInfo, itemName, txtPrice, checkoutButton, checkoutTitle
        } = styles;
            ...
            <View style={wrapper}>
                <View style={cardStyle}>
                    ...
                    <ScrollView style={footer}>
                        ...
                        <TouchableOpacity style={checkoutButton} onPress={orderStatus == "Completed" ? () => {
                            const { navigation } = this.props;
                            ...
                            <Text style={checkoutTitle}>{orderStatus == "Completed" ? 'Give rating' : 'Cancel Order'}</Text>
                        </TouchableOpacity>
                    </ScrollView>
                </View>
            </View>
